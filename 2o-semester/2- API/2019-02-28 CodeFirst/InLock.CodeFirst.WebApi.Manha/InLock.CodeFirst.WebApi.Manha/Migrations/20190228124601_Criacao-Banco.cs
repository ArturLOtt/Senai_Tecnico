...
namespace InLock.CodeFirst.WebApi.Manha.Migrations
{
    ...
    {
        // Add-Migration Criacao-Banco <-<-<-<-<-<- no powershell
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeEstudio = table.Column<string>(type: "varchar(250)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JogoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NomeJogo = table.Column<string>(type: "varchar(250)", nullable: false),
